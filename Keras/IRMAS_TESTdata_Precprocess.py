...
npz_dest = 'D:\\SD Project\\IRMAS\\IRMAS-TestingData-Part1\\IRMAS-TestingData-Part1\\IRMAS_testdataPt1.npz' #change to location for npz to be saved 

t_labels = test_labels_IRMAS(fpath)
